  ...
  for(i=0;i<m;i++)
   {
       ...
       printf("\nEnter the number of ones scored by player%d: ",i+1);
       scanf("%d",&pl1[i].ones);


       printf("\nEnter the number of twos scored by player%d: ",i+1);
       scanf("%d",&pl1[i].twos);


       printf("\nEnter the number of threes scored by player%d: ",i+1);
       scanf("%d",&pl1[i].threes);


       printf("\nEnter the number of fours scored by player%d: ",i+1);
       scanf("%d",&pl1[i].fours);


       printf("\nEnter the number of sixes scored by player%d: ",i+1);
       scanf("%d",&pl1[i].sixes);


       printf("\nEnter the balls played by the player%d: ",i+1);
       scanf("%d",&pl1[i].balls);
   }
